namespace Verve
{
    ...
    public static class SerializerExtensions
    {
        ...
        ///   <para>序列化后二进制数据</para>
        /// </returns>
        public static byte[] SerializeToBytes(this ISerializer self, object obj)
        {
        ...
        ///   <para>反序列化对象</para>
        /// </returns>
        public static T Deserialize<T>(this ISerializer self, byte[] value)
        {
        ...
        public static T Deserialize<T>(this ISerializer self, string value, Encoding encoding = null)
        {
            ...
            return self.Deserialize<T>(bytes);
        }
    }
}