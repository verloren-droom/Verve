...
namespace Verve
{
    ...
    /// </summary>
    [Serializable]
    public struct GameObjectRef : IComponent, IEquatable<GameObjectRef>, ICloneable
    {
        /// <summary>
        ///   <para>游戏对象</para>
        /// </summary>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] object ICloneable.Clone() => Clone();
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public GameObjectRef Clone() => new GameObjectRef { go = UnityEngine.Object.Instantiate(go) };
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public override int GetHashCode() => go?.GetHashCode() ?? 0;
