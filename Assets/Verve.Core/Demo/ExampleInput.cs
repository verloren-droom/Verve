...
namespace Verve.Example
{
    ...
    public class ExampleInput : ComponentBase
    {
        ...
        protected override void Start()
        {
            ...
            GameLauncher.Instance.TryGetUnit(out m_Input);
            GameLauncher.Instance.TryGetUnit(out m_LoaderUnit);
        ...
        private void OnJumpAction(InputServiceContext<bool> obj)
        {
            ...
            m_Input.RemoveListener<InputManagerService, bool>("Jump", OnJumpAction);
        }
